const LogoIcon = () => (
  <svg width="28" height="32" viewBox="0 0 32 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="50%" y="55%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="11" fontWeight="700" fontFamily="DM Sans, sans-serif">SF</text>
  </svg>
)
...
const projectLinks = ['Projects', 'Blog']
        ...
        <div className="grid grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              <LogoIcon />
              <span className="font-serif font-bold text-xl text-white tracking-wide">LIBR</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              {socialIcons.map(({ Icon, href, label }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-8 h-8 flex items-center justify-center rounded-full bg-white/10 text-white/70 hover:bg-white/20 hover:text-white transition-colors duration-200"
                >
                  <Icon />
                </a>
              ))}
          ...
          {/* Col 2 – Navigation */}
          <div>
            <h4 className="font-sans font-semibold text-white text-sm mb-5 uppercase tracking-widest opacity-90">
              Navigation
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-white/50">
                <MailIcon />
                <a href="mailto:syifaarizal@gmail.com" className="font-sans text-sm hover:text-white transition-colors duration-200">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-8 py-5 flex items-center justify-between">
          <p className="font-sans text-xs text-white/40">
            © 2024 LIBR. All rights reserved.
          </p>
          <p className="font-sans text-xs text-white/40">
            Built with{' '}
            <span className="text-red-400">♥</span>
            {' '}by Syifa Fauziyah Arizal
          </p>
        </div>
      </div>
    </footer>
