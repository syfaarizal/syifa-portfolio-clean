...
export default function Html1Page() {
  return (
    ...
    >
      ...
      <section>
        <h2 className="mb-5 font-bold">What is HTML?</h2>
      ...
      <section>
        <h2 className="mb-5 font-bold">Basic HTML Terms</h2>
...
{`<p>Hello World</p>`}
      ...
      <section>
        <h2 className="mb-5 font-bold">Meta Tags</h2>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">`}
      ...
      <section>
        <h2 className="mb-5 font-bold">Text Formatting</h2>
...
<u>Underline</u>`}
      ...
      <section>
        <h2 className="mb-5 font-bold">Anchor Tags</h2>
...
{`<a href="https://google.com" target="_blank">
  Search on Google
      ...
      <section>
        <h2 className="mb-5 font-bold">Images</h2>
...
{`<img src="image.jpg" alt="Cute Cat Picture">`}
      ...
      <section>
        <h2 className="mb-5 font-bold">Tables</h2>
