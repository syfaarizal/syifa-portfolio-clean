...
🎉 30 is an even number & multiple of 10!`}
      ...
      <section>
        <h2 className="mb-5 font-bold">Challenge Goals</h2>
      ...
      <section>
        <h2 className="mb-5 font-bold">Basic Implementation</h2>
...
if (isNaN(input)) {
    ...
    console.log("This is an odd number 👌");
      ...
      <section>
        <h2 className="mb-5 font-bold">Adding a Special Case</h2>
...
{`else if (input % 10 === 0 && input % 2 === 0)`}
      ...
      <section>
        <h2 className="mb-5 font-bold">Version With Special Logic</h2>
...
if (isNaN(input)) {
    ...
    console.log("🔹 This is an odd number!");
      ...
      <section>
        <h2 className="mb-5 font-bold">Bonus Challenge: Loop Version</h2>
...
while (true) {
    ...
    if (isNaN(number)) {
      ...
      <section>
        <h2 className="mb-5 font-bold">Final Version</h2>
